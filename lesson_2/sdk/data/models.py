...
class Networks:
    ...
    Fantom =  Network(
        ...
        api=API(
            key=config.FANTOM_API_KEY, url='https://api.ftmscan.com/', docs='https://ftmscan.com/apis'
        )
    )
    ...
    HECO = Network(
        ...
        api=API(
            key=config.HECO_API_KEY, url='https://api.hecoinfo.com/',
            docs='https://www.hecoinfo.com/en-us/apis'
        )
    )
...
class Unit:
    ...
    def __imul__(self, other):
        ...
        # Почему-то на счет этого я не уверен
